 ...
 * @date 2025-06-24
 * 
 * @copyright {nauvalachid@umy.ac.id (c) 2025}
 */
#include <iostream>
using namespace std;
/**
 ...
 */
	...
	void display() {
		...
		if (FRONT_position <= REAR_position) {
			...
			//jika FRONT_positon > REAR_position,iterasi dari FRONT hingga akhir array
 ...
 */
int main() {
	Queues q;///< objek untuk menggunakan member yang ada pad class Queues
